...
#ifndef log_appender_type_rollingfile_h
#define log_appender_type_rollingfile_h

/**
 * @file appender_type_rollingfile.h
 *
 * @brief log rolling file appender interface.
 *
 ...
 */
int rollingfile_udata_set_logdir(
 ...
 * @return zero if successful, non-zero otherwise.
 */                            
int rollingfile_udata_set_files_prefix(
              rollingfile_udata_t *rfudatap,
              const char * prefix);
/**
 ...
 * @return the prefix.
 */ 
const char* rollingfile_udata_get_files_prefix(
                            rollingfile_udata_t* rfudatap);

...
#ifndef log_appender_type_stream2_h
#define log_appender_type_stream2_h

/**
 * @file appender_type_stream2.h
 *
 * @brief log stream2 appender interface.
 *
 ...
 *
 * myappender = log_appender_get("/var/logs/mylog.log");
 * log_appender_set_type(myappender,log_appender_type_get("stream2"));
 *
 * @endcode
 *
 ...
 * option setting, closing.  If you set the file pointer log will
 ...
 * log_appender_set_type(myappender, log_appender_type_get("stream2"));
 * log_stream2_set_fp(stream2_appender,myfp);
 *
 * @endcode
 *
 ...
 * log file:
 *
 * @code log_appender_t* myappender;
 *
 * myappender = log_appender_get("/var/logs/mylog.log");
 * log_appender_set_type(myappender,log_appender_type_get("stream2"));
 * log_stream2_set_flags(myappender, log_STREAM2_UNBUFFERED);
 *
 * @endcode
 *
 **/
 ...
 */      
void log_stream2_set_fp(log_appender_t* a_this, FILE *fp);
 ...
 * 
 */ 
FILE * log_stream2_get_fp(log_appender_t* a_this);
 ...
 * Currently supported flags:  log_STREAM2_UNBUFFERED
 * 
 */
void log_stream2_set_flags(log_appender_t* a_this, int flags);
#define LOG_STREAM2_UNBUFFERED 0x01
 ...
 */
int log_stream2_get_flags(log_appender_t* a_this);
